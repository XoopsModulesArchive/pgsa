...
function PGSAAdmin() {
        ...
        echo "<h4 sty	le='text-align:left;'>"._AM_PGSA_ADDMENUITEM."</h4>
       ...
       echo "<h4 style='text-align:left;'>"._AM_PGSA_CHANGEMENUITEM."</h4>
        ...
        <td class='bg2'>
                ...
                echo "<td><a href='index.php?op=PGSAEdit&server_id=$server_id'>"._AM_PGSA_EDIT."</a> | <a href='index.php?op=PGSADel&amp;server_id=$server_id&amp;ok=0'>"._AM_PGSA_DELETE."</a></td>
                </tr>";
                }
                echo "</table>
        </td>
...
function PGSASave($server_id, $server_name, $server_ip, $server_port, $server_rconpassword) {
        ...
        redirect_header("index.php?op=PGSAAdmin",1,_AM_PGSA_DBUPDATED);
        exit();
}
...
function PGSADel($server_id, $ok=0) {
        ...
        if ( $ok == 1 ) {
                ...
                echo "<td width='3%'>\n";
                echo myTextForm("index.php?op=PGSADel&server_id=$server_id&ok=1", _AM_PGSA_YES);
                echo "</td><td>\n";
                echo myTextForm("index.php?op=PGSAAdmin", _AM_PGSA_NO);
                echo "</td></tr></table>\n";
                CloseTable();
        }
}
